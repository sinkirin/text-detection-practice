...
if __name__ == '__main__':
    ...
    bbox5 = np.array([[[167, 113], [226, 113], [226, 433], [167, 433]],[[223, 118], [289, 118], [289, 438], [223, 438]]])
    # image = gaussian.add_region_character(image, bbox)
    # print(image.max())
    image = gaussian.generate_region((500, 500, 1), [bbox5])

    words = ["19"]
    image = gaussian.generate_affinity((500, 500, 1), [bbox5], words)
    image = image[0]
    ...
    test1 = cv2.resize(target_gaussian_heatmap_color,(741,350))
    cv2.imshow("resized", test1)
    cv2.waitKey()
